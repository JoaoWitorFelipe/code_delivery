...
export class Route {
  ...
  constructor(options: {
    currenctMarkerOptions: google.maps.ReadonlyMarkerOptions;
    endMarkerOptions: google.maps.ReadonlyMarkerOptions;
  }) {
    const { currenctMarkerOptions, endMarkerOptions } = options;
    this.currentMarker = new google.maps.Marker(currenctMarkerOptions);
...
export class Map {
  ...
  addRoute(
    ...
    const { currenctMarkerOptions, endMarkerOptions } = routeOptions;
    this.routes[id] = new Route({
      currenctMarkerOptions: { ...currenctMarkerOptions, map: this.map },
